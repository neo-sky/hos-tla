...
use crate::events::{self, BusinessSubCapEvent, RetractionCanceledEvent, RetractionScheduledEvent};
use crate::fees;
use crate::types::*;
...
impl TlaRegistry {
    ...
    pub fn schedule_retraction(
        ...
        events::emit(
            "sub_account_retraction_scheduled",
            &RetractionScheduledEvent {
                full_name: &key,
                retraction_at: now,
                by: caller.as_str(),
            },
    ...
    pub fn cancel_retraction(
        ...
        events::emit(
            "sub_account_retraction_canceled",
            &RetractionCanceledEvent {
                full_name: &key,
                by: caller.as_str(),
            },
        );
    ...
    pub fn get_business_renewal_cost(
        ...
        let per_sub = self.fee_config.sub_fee_per_account;
